...
#######################################################################
        ...
        # ~ a = os.path.join(r"C:\Users\Public\Videos\Sample Videos\video_1.mp4")#,"13-ta-com-raiva-de-mim.mp3")
        # ~ print(a)
        media = self.instance.media_new(r"C:\Users\Public\Videos\Sample Videos\video_1.mp4")
        # ~ media = self.instance.media_new(r"C:\Users\Public\Videos\Sample Videos\13-ta-com-raiva-de-mim.mp3")
        print(media)
        self.media_list.set_media(media)#
        self.media_player.set_media_list(self.media_list)#
        print("MEDIA COUNT", self.media_list.count())
        print("META", media.get_meta(0))
        
        if sys.platform.startswith("linux"):  # for Linux using the X Server
            self.mediaplayer.set_xwindow(self.videoframe.winId())
        elif sys.platform == "win32":  # for Windows
            self.media_player.get_media_player().set_hwnd(self.videoframe.winId())
        ...
        # ~ self.mediaplayer.audio_set_volume(20)
...
##            self.fullScreenButton.setEnabled(False)
    ...
    def volume_encoder(self, vol):
        ...
        print(self.mediaplayer.audio_set_volume(vol))
...
##                    self.playlist.load(url)
    ...
    def durationChanged_vlc(self, event):
        ...
        positionChanged
        '''
        print("META", self.mediaplayer.get_meta(0))
